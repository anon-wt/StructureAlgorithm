...
public class ReservePolishMultiCal {
    ...
    public static List<String> doMatch(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            if (isSymbol(s.charAt(i) + "")) {
                ...
                if (stack.isEmpty() || LEFT.equals(each)
                    ...
                    // )操作符，依次出栈入列直到空栈或遇到第一个(操作符，此时(出栈
        ...
        // 如果栈里还有元素，此时元素需要依次出栈入列，可以想象战力上下栈顶为/，栈底为+ 应该依次出栈入列，可以直接反转整个stack,添加到list;
